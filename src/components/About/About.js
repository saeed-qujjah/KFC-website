...
import kfc1 from '../../assests/images/469-Combo2.png'
import offer from '../../assests/images/photo.jpg'
    ...
    return (
        <div className='mt-[32px] w-[1280px] px-[117px] relative grid gap-x-[44px] gap-y-[76px]' style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(500px, 1fr))' }}>
            ...
            <div className='cursor-pointer w-[502px] h-[309px] bg-[#FFFFFF] rounded-md relative flex items-center' style={{ fontFamily: 'Ibarra Real Nova' }}>
                <img src={offer} alt='' className='w-[210px] ml-2' />
                <img src={kfc1} alt='' className='w-[296px] absolute right-0' />
                <div className='absolute left-[15px] top-0 w-[54px] h-[19px] flex justify-between items-center'>
